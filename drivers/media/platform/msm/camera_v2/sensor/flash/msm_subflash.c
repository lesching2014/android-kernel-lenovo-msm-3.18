...
#define HQ_CUSTOM_FRONT_TORCH_BRIGHTNESS 50
...
static const struct i2c_device_id msm_flash_i2c_id[] = {
	{"qcom,camera-subflash", (kernel_ulong_t)NULL},
	{ }
};
				...
				enum led_brightness value)
{
	...
	if (value) {
	    value = HQ_CUSTOM_FRONT_TORCH_BRIGHTNESS;
	}

	pr_err("set subtorch brightness: value = %d\n",value);
