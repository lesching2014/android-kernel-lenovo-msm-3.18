...
/* Register offsets */
#define SUPPORT_CUSTOM_FG_SRAM_UPDATE_PERIOD
/* Interrupt offsets */
...
#ifdef SUPPORT_CUSTOM_FG_SRAM_UPDATE_PERIOD
...
static int update_irq_volt_empty(struct fg_chip *chip)
{
	...
	pr_err("update batt empty soc irq, voltage = %d\n",volt_mv);
