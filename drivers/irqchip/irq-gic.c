...
/* Huaqin add for OAUSTIN2018/OAUSTINB-579 Change log wakeup reason by lingyuguo at 2018/05/08 start */
		//log_base_wakeup_reason(i + gic->irq_offset);
		log_base_wakeup_reason(irq);
/* Huaqin add for OAUSTIN2018/OAUSTINB-579 Change log wakeup reason by lingyuguo at 2018/05/08 end */
	}
}
